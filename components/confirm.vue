	...
	<view class="dialog-box" v-if='show' >
	  ...
	  <view class='show-dialog'>
	    ...
	    <view class="dialog-buttons">
	      <view class='button1'>
	        <button class=" dialog-buttons-item" @tap="cancel" >待改进 </button>
	      </view>
	      <view class='button2'>
	        <button class=" dialog-buttons-item" @tap='confirm' style="color:yellowgreen;" open-type="share">转发一下</button> 
	      </view>
	    </view>
